...
- Generate ALL charts first using codeInterpreter, one chart per code cell
- After ALL charts are generated, call persistAllCharts exactly ONCE after ALL charts are done
- MANDATORY: You MUST call persistAllCharts once after all charts are generated. This is not optional.
